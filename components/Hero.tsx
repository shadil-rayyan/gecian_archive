...
const Hero = () => {
  return (
    <div className=" h-screen bg-gradient-to-t from-[#104E69] to-[#2AACCA] flex  justify-start items-center relative overflow-hidden">
      <div className="flex flex-col md:w-1/2 md:pl-32 p-8 z-20">
      ...
      <div className="md:w-[842.12px] w-[80px] h-[80px] md:h-[674.12px] bg-gradient-to-t to-[#2CB1CF] from-[#1D7589] shadow-2xl z-10 absolute md:-top-[233.85px] top-[100px] md:-right-[301.03px] right-[80px] transform rotate-[115.88deg] transition-all duration-300 ease-in-out"></div>
    </div>
  );
};
